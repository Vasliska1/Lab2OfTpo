...
public class LogMocks {
    ...
    public static Ln getLnMock() {
        ...
        when(ln.calculate(AdditionalMatchers.eq(0.0, 0.1))).thenReturn(Double.NaN);
    ...
    public static Log3 getLog3Mock() {
        ...
        when(log3.calculate(AdditionalMatchers.eq(0.0, 0.1))).thenReturn(Double.NaN);
    ...
    public static Log5 getLog5Mock() {
        ...
        when(log5.calculate(AdditionalMatchers.eq(0.0, 0.1))).thenReturn(Double.NaN);
    ...
    public static Log10 getLog10Mock() {
        ...
        when(log10.calculate(AdditionalMatchers.eq(0.0, 0.1))).thenReturn(Double.NaN);
    ...
    public static Log2 getLog2Mock() {
        ...
        when(log2.calculate(AdditionalMatchers.eq(0.0, 0.1))).thenReturn(Double.NaN);
        when(log2.calculate(AdditionalMatchers.eq(0.2, 0.1))).thenReturn(-2.32193);
        when(log2.calculate(AdditionalMatchers.eq(0.5, 0.1))).thenReturn(-1.0);
        when(log2.calculate(AdditionalMatchers.eq(0.8, 0.1))).thenReturn(-0.321928);
        when(log2.calculate(AdditionalMatchers.eq(1.0, 0.1))).thenReturn(0.0);
        when(log2.calculate(AdditionalMatchers.eq(1.2, 0.1))).thenReturn(0.263034);
        when(log2.calculate(AdditionalMatchers.eq(1.5, 0.1))).thenReturn(0.583963);
